...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Contact Us | Kenya Criminal Legal Agent Assistant</title>
        <meta name="description" content="Contact the Kenya Criminal Legal Agent Assistant team for support and inquiries" />
      </Head>
      ...
      <main className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-light">Get in touch with our team for support and inquiries</p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-neutral">Phone</h4>
                    <p className="mt-1 text-neutral-light">+254 778401063</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-neutral">Email</h4>
                    <p className="mt-1 text-neutral-light">info@sureintel.co.ke</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-neutral">Location</h4>
                    <p className="mt-1 text-neutral-light">Nairobi, Kenya</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-neutral">WhatsApp</h4>
                    <p className="mt-1 text-neutral-light">+254 778401063</p>
                    <a href="https://wa.me/254778401063" className="mt-2 inline-flex items-center text-primary hover:text-primary-dark">
              ...
              <div className="mt-8">
                <h4 className="text-lg font-medium text-neutral mb-4">Connect With Us</h4>
          ...
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
            ...
            <p className="mb-4">For faster responses, connect with us directly through WhatsApp:</p>
